...
for partition_size in ClusterEdgeRemover.analysis_hyperparameters()['partition_size']:
    ...
    classifier.test_with_datasets_from_path(f'./{DATASET_PATH}/test', save_result=True, detect_clusters=False, save_predictions=False, apply_threshold=True, check_if_predictions_file_name_exists=True, ignore_non_clustered_localizations=False)
